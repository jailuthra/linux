...
#if IS_ENABLED(CONFIG_RPMSG_KDRV_DISPLAY)
extern void *rpmsg_kdrv_display_device_init(struct rpmsg_device *rpdev, struct rpmsg_kdrv_init_device_info *dinfo);
extern int rpmsg_kdrv_display_driver_init(void);
extern void rpmsg_kdrv_display_driver_fini(void);
#else
static inline void *rpmsg_kdrv_display_device_init(struct rpmsg_device *rpdev, struct rpmsg_kdrv_init_device_info *dinfo)
{
	return NULL;
}
static inline int rpmsg_kdrv_display_driver_init(void)
{
	return 0;
}
static inline void rpmsg_kdrv_display_driver_fini(void)
{
}
#endif
