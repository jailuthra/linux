...
uint32_t check_min(uint32_t a, uint32_t b, int line)
{
...
void *rpmsg_kdrv_display_device_init(struct rpmsg_device *rpdev, struct rpmsg_kdrv_init_device_info *dinfo)
{
	return NULL;
}
EXPORT_SYMBOL(rpmsg_kdrv_display_device_init);
...
int __init rpmsg_kdrv_display_driver_init(void)
{
	return rpmsg_kdrv_register_driver(&rpmsg_kdrv_display);
}
EXPORT_SYMBOL(rpmsg_kdrv_display_driver_init);

void rpmsg_kdrv_display_driver_fini(void)
{
}
EXPORT_SYMBOL(rpmsg_kdrv_display_driver_fini);
