					...
					struct k3_dsp_rproc *kproc)
{
	...
	for (i = 0; i < num_mems; i++) {
		/* C7x cores only have a L1P Cache, there are no L1P SRAMs */
		if (of_device_is_compatible(np, "ti,dra822-c711-dsp") &&
...
static int k3_dsp_rproc_probe(struct platform_device *pdev)
{
	...
	/* C7x is a 64-bit processor, so customize rproc elf loader ops */
	if (of_device_is_compatible(np, "ti,dra822-c711-dsp")) {
...
static const struct k3_dsp_rproc_dev_data dra822_c66_dsp_dev_data[] = {
	{
		.device_name	= "4d80800000.dsp",
		.fw_name	= "dra82x-c66_0-fw",
	},
	{
		.device_name	= "4d81800000.dsp",
		.fw_name	= "dra82x-c66_1-fw",
	},
	{
		/* sentinel */
	},
...
static const struct k3_dsp_rproc_dev_data dra822_c71_dsp_dev_data[] = {
	{
		.device_name	= "64800000.dsp",
		.fw_name	= "dra82x-c71-fw",
	},
	{
		/* sentinel */
	},
...
static const struct of_device_id k3_dsp_of_match[] = {
	{
		.compatible = "ti,dra822-c66-dsp",
		.data = dra822_c66_dsp_dev_data,
	},
	{
		.compatible = "ti,dra822-c711-dsp",
		.data = dra822_c71_dsp_dev_data,
	},
	{ /* sentinel */ },
};
