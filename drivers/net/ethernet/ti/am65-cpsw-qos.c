...
static void am65_cpsw_qos_cut_thru_dump(struct am65_cpsw_port *port)
{
	struct am65_cpsw_common *common = port->common;
	...
	dev_info(common->dev, "Port%u: cut_thru dump control:%08x cut_thru:%08x hwspeed:%08x\n",
...
static void am65_cpsw_cut_thru_enable(struct am65_cpsw_common *common)
{
	...
	writel(common->bus_freq_mhz, common->cpsw_base + AM65_CPSW_REG_FREQ);
...
void am65_cpsw_qos_cut_thru_init(struct am65_cpsw_port *port)
{
	...
	am65_cpsw_qos_cut_thru_dump(port);
}
