...
enum dss7_common_regs {
	...
	DSS7_COMMON_REG_TABLE_LEN,
};

/*
 * dispc7_common_regmap should be defined as const u16 * and pointing
 * to a valid dss common register map for the platform, before the
 * macros bellow can be used.
 */

#define REG(r) (dispc7_common_regmap[r ## _OFF])
...
#define DISPC_VID_DMA_BUFSIZE		0x2bc /* DRA8 */

/* OVR */

#define DISPC_OVR_CONFIG		0x0
#define DISPC_OVR_VIRTVP		0x4 /* DRA8 */
...
#define DISPC_OVR_ATTRIBUTES2(n)	(0x34 + (n) * 4) /* DRA8 */
/* VP */
...
#define DISPC_VP_DSS_MERGE_SPLIT		0x16c /* DRA8 */
#define DISPC_VP_DSS_DMA_THREADSIZE		0x170 /* DRA8 */
#define DISPC_VP_DSS_DMA_THREADSIZE_STATUS	0x174 /* DRA8 */
