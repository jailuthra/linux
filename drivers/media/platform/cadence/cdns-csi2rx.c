...
static const struct csi2rx_fmt formats[] = {
	...
	{ .code	= MEDIA_BUS_FMT_RAW_8, .bpp = 8, .max_pixels = 4, },
	{ .code	= MEDIA_BUS_FMT_META_8, .bpp = 8, .max_pixels = 4, },
	...
	{ .code	= MEDIA_BUS_FMT_RAW_10, .bpp = 10, .max_pixels = 2, },
	{ .code	= MEDIA_BUS_FMT_META_10, .bpp = 10, .max_pixels = 2, },
	...
	{ .code	= MEDIA_BUS_FMT_Y12_1X12, .bpp = 12, .max_pixels = 2, },
	{ .code	= MEDIA_BUS_FMT_RAW_12, .bpp = 12, .max_pixels = 2, },
	{ .code	= MEDIA_BUS_FMT_META_12, .bpp = 12, .max_pixels = 2, },
