...
#define PVDEC_CORE_CR_PVDEC_PROC1_INTERRUPT_STATUS_CR_PROC1_COMMAND_TIMEOUT_PROC_IRQ_SIGNED_FIELD	(0)
...
#define PVDEC_CORE_CR_PVDEC_PROC1_INTERRUPT_STATUS_CR_PROC1_COMMAND_TIMEOUT_HOST_IRQ_SIGNED_FIELD	(0)
...
#define PVDEC_CORE_CR_PVDEC_PROC2_INTERRUPT_STATUS_CR_PROC2_COMMAND_TIMEOUT_PROC_IRQ_SIGNED_FIELD	(0)
...
#define PVDEC_CORE_CR_PVDEC_PROC2_INTERRUPT_STATUS_CR_PROC2_COMMAND_TIMEOUT_HOST_IRQ_SIGNED_FIELD	(0)
