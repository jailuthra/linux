...
typedef void (*swsr_callback_fxn)(enum swsr_cbevent event,
				  void *priv_data,
				  u8 nal_type, u8 **data_buffer,
				  u64 *data_size);

int swsr_get_total_bitsconsumed(void *context, u64 *total_bitsconsumed);
 ...
 */
int swsr_get_byte_offset_curbuf(void *context, u64 *byte_offset);
 ...
 * using SWSR_CheckException(). In this event the function returns 0.
 */
u32 swsr_read_unsigned_expgoulomb(void *context);
 ...
 */
int swsr_check_more_rbsp_data(void *context, bool *more_rbsp_data);
 ...
 * using SWSR_CheckException(). In this event the function returns 0.
 */
u32 swsr_read_onebit(void *context);
 ...
 * using SWSR_CheckException(). In this event the function returns 0.
 */
u32 swsr_read_bits(void *context, u32 no_bits);

int swsr_read_signedbits(void *context, u32 no_bits);
 ...
 */
u32 swsr_peekbits(void *context, u32 no_bits);
 ...
 */
int swsr_get_current_delimited_unitsize(void *context, u32 *size);
 ...
 * in it.
 */
int swsr_get_current_delimited_unit(void *context, u8 *data, u32 *size);
 ...
 */
int swsr_get_current_delimited_unit_bit_offset(void *context, u32 *bit_offset);
