...
#define MSVDX_VEC_CR_VEC_ENTDEC_INFORMATION_2_BE_ENTDEC_LATEST_MB_ADDR_Y_LSBMASK		(0x000000FF)
...
#define MSVDX_VEC_CR_VEC_ENTDEC_INFORMATION_2_BE_ENTDEC_LATEST_MB_ADDR_X_LSBMASK		(0x000000FF)
