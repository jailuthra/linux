...
struct hevcfw_profile_tier_level {
	...
	unsigned char sub_layer_profile_compatibility_flag[HEVCFW_MAX_NUM_SUBLAYERS - 1][HEVCFW_MAX_NUM_PROFILE_IDC];
...
struct hevcfw_picture_ps {
	...
	char cb_qp_offset_list[HEVCFW_MAX_CHROMA_QP];
	char cr_qp_offset_list[HEVCFW_MAX_CHROMA_QP];
...
struct hevcfw_reference_picture_set {
	...
	char ref_picsetlt_curr[HEVCFW_MAX_NUM_REF_PICS];
	char ref_picsetlt_foll[HEVCFW_MAX_NUM_REF_PICS];
	char ref_picsetst_curr_before[HEVCFW_MAX_NUM_REF_PICS];
	char ref_picsetst_curr_after[HEVCFW_MAX_NUM_REF_PICS];
	char ref_picsetst_foll[HEVCFW_MAX_NUM_REF_PICS];
};
...
struct hevcfw_ctx_data {
	 ...
	 */
	char ref_pic_list[HEVCFW_NUM_REF_PIC_LISTS][HEVCFW_MAX_NUM_REF_PICS];
	/*
	 ...
	 */
	char ref_pic_listhlp[HEVCFW_NUM_REF_PIC_LISTS][HEVCFW_MAX_NUM_REF_PICS];
