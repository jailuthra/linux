...
struct bspp_h264_inter_pict_ctx {
	 ...
	 */
	u32 active_sps_for_sei_parsing;
	u16 current_view_id;
...
struct bspp_parse_state {
	...
	u32 prev_first_mb_in_slice[MAX_COMPONENTS];
	struct bspp_pict_hdr_info *next_pict_hdr_info;
	u8 prev_bottom_pic_flag;
	u8 second_field_flag;
	u8 next_pic_is_new;
	u32 prev_frame_num;
	u32 prev_pps_id;
	u32 prev_field_pic_flag;
	u32 prev_nal_ref_idc;
	u32 prev_pic_order_cnt_lsb;
	s32 prev_delta_pic_order_cnt_bottom;
	s32 prev_delta_pic_order_cnt[2];
	s32 prev_nal_unit_type;
	s32 prev_idr_pic_id;
	int discontinuous_mb;
	/* Position in bitstream before parsing a unit */
	u64 prev_byte_offset_buf;
	u32 prev_buf_map_id;
	u32 prev_buf_data_size;
	/*
 ...
 * @Return	s32 : This function returns either IMG_SUCCESS or an error code.
 */
typedef s32 (*bspp_cb_parse_unit)(void *swsr_context_handle,
 ...
 * @Return	s32 : This function returns either IMG_SUCCESS or an error code.
 */
typedef s32 (*bspp_cb_release_data)(void *str_alloc_handle,
 ...
 * @Return	s32 : This function returns either IMG_SUCCESS or an error code.
 */
typedef s32 (*bspp_cb_reset_data)(enum bspp_unit_type data_type,
				  void *data_handle);
 ...
 * @Return	s32 : This function returns either IMG_SUCCESS or an error code.
 */
typedef s32 (*bspp_cb_destroy_data)(enum bspp_unit_type data_type,
				    void *data_handle);
 ...
 * @Return	s32 : This function returns either IMG_SUCCESS or an error code.
 */
typedef s32 (*bspp_cb_set_parser_config)(enum vdec_bstr_format bstr_format,
 ...
 * @Return	None.
 */
typedef void (*bspp_cb_determine_unit_type)(u8 bitstream_unit_type,
					    int disable_mvc,
