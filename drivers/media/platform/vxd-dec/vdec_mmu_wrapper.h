 ...
 */
int mmu_stream_get_ptd_handle(void *mmu_str_handle,
			      void **str_ptd);
 ...
 * @Return	IMG_SUCCESS or an error code.
 */
int mmu_stream_create(void *mmudev_hndl,
		      u32 km_str_id,
		      void *vxd_dec_ctx,
		      void **mmustr_hndl);
 ...
 *		(1, 2, 4, 8, 16 etc).
 * @Output	ddbuf_info : A pointer to a #vxdio_ddbufinfo structure
 ...
 * @Input	ps_dd_buf_info : A pointer to a #vxdio_ddbufinfo structure.
 * @Return	IMG_SUCCESS or an error code.
 */
