...
#define IS_H264_HIGH_PROFILE(profile_idc) ({ \
		typeof(val) __profile_idc = profile_idc; \
...
struct h264fw_sequence_ps {
	...
	IMG_ALIGN_FIELD(VDECFW_SHARE_DEFAULT_ALIGNMENT, unsigned short,
			anchor_inter_view_reference_id_list[2][H264FW_MAX_NUM_VIEWS][H264FW_MAX_NUM_MVC_REFS]);
	/* nonanchor reference list */
	IMG_ALIGN_FIELD(VDECFW_SHARE_DEFAULT_ALIGNMENT, unsigned short,
			non_anchor_inter_view_reference_id_list[2][H264FW_MAX_NUM_VIEWS][H264FW_MAX_NUM_MVC_REFS]);
...
struct h264fw_picture_ps {
	...
	IMG_ALIGN_FIELD(VDECFW_SHARE_DEFAULT_ALIGNMENT, char, pic_init_qp);
	/* syntax element from bitstream - 1 bit */
	IMG_ALIGN_FIELD(VDECFW_SHARE_DEFAULT_ALIGNMENT, unsigned char,
