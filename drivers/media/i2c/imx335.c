...
#define IMX335_PIXEL_ARRAY_LEFT		28U
#define IMX335_PIXEL_ARRAY_TOP		50U
#define IMX335_PIXEL_ARRAY_WIDTH	2640U
...
static const struct cci_reg_sequence mode_1320x972_regs[] = {
	{ IMX335_REG_MODE_SELECT, IMX335_MODE_STANDBY },
	{ IMX335_REG_MASTER_MODE, 0x00 },
...
static const struct cci_reg_sequence mode_1320x972_vflip_normal[] = {
	{ IMX335_REG_AREA3_ST_ADR_1, 176 },
...
static const struct cci_reg_sequence mode_1320x972_vflip_inverted[] = {
	{ IMX335_REG_AREA3_ST_ADR_1, 4112 },
...
static const struct imx335_mode supported_modes[] = {
	{
		...
		.pclk = 396000000,
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_1320x972_regs),
			.regs = mode_1320x972_regs,
		},
		.vflip_normal = {
			.num_of_regs = ARRAY_SIZE(mode_1320x972_vflip_normal),
			.regs = mode_1320x972_vflip_normal,
		},
		.vflip_inverted = {
			.num_of_regs = ARRAY_SIZE(mode_1320x972_vflip_inverted),
			.regs = mode_1320x972_vflip_inverted,
		},
	},
};
